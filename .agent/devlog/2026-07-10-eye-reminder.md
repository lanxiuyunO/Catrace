...
| 文件 | 变更 |
|------|------|
| `src-tauri/src/eye.rs` | 新增护眼提醒模块 |
| `src-tauri/src/lib.rs` | 集成护眼提醒到每分钟结算循环 |
| `src-tauri/src/reminder_toast.rs` | 全局 Mutex 串行化 Toast 窗口操作 |
| `src/views/ReminderToast.vue` | 护眼卡片、显示器工作区定位、去重、滚动 |
