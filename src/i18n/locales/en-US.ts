export default {
  ...
  reminder: {
    ...
    restCountdownTitle: 'Rest Countdown',
    restCountdownBody: 'Rested for {n} minutes, {m} minutes to go',
    restCountdownDone: 'Break Complete',
    restCountdownDoneBody: 'Rested for {n} minutes',
    restCountdownHint: '{n} minutes counts as a valid break',
    editMode: 'Edit Mode',
    lock: 'Lock',
    unlock: 'Unlock',
    scale: 'Scale',
