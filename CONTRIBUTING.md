...
```bash
# 克隆仓库
git clone https://github.com/lanxiuyunO/Catrace.git
cd Catrace
...
在提交 Issue 前，请先搜索 [已有 Issue](https://github.com/lanxiuyunO/Catrace/issues)，避免重复。
...
- **Issues**: Search [existing issues](https://github.com/lanxiuyunO/Catrace/issues) first. Include OS, app version, steps to reproduce, and expected vs actual behavior.
